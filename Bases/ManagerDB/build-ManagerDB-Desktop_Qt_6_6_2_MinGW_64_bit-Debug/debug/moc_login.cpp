...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLoginENDCLASS_t qt_meta_stringdata_CLASSLoginENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 12),  // "signal_login"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 10)   // "slot_login"
    },
    "Login",
    "signal_login",
    "",
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signal_login(); break;
        case 1: _t->slot_login(); break;
        default: ;
        }
        ...
        {
            using _t = void (Login::*)();
            if (_t _q_method = &Login::signal_login; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
