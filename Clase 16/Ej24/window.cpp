...
void Window::slot_pbUrl_clicked() {
    QNetworkRequest request(QUrl(ui->leUrl->text()));
    manager.get(request);
}

void Window::slot_selectDirectory_clicked() {
...
void Window::slot_selectImage_clicked() {
...
void Window::downloadFile(const QString &urlString)
{
    QUrl url(urlString);
